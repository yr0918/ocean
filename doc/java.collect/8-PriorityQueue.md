...
![PriorityQueue_base.png](png/PriorityQueue_base.png)
...
![PriorityQueue_offer.png](png/PriorityQueue_offer.png)
...
![PriorityQueue_peek.png](png/PriorityQueue_peek.png)
...
![PriorityQueue_poll.png](png/PriorityQueue_poll.png)
代码如下：
```Java
public E poll() {
    if (size == 0)
...
![PriorityQueue_remove2.png](png/PriorityQueue_remove2.png)
